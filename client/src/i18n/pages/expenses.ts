export default {
  uz: {
    ...
    categoryTooLong: "Toifa nomi 50 belgidan oshmasligi kerak",
    categoryPlaceholder: "Tanlang yoki o'zingiz yozib Enter bosing",
    amountLabel: 'Summa',
  ...
  ru: {
    ...
    categoryTooLong: 'Название категории не должно превышать 50 символов',
    categoryPlaceholder: 'Выберите или введите свою и нажмите Enter',
    amountLabel: 'Сумма',
